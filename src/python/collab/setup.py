...
setup(
    ...
    version = "0.1.0",
    description = "XMPP-based, distributed mathematics framework",
    author = "Simon Parry",
    author_email = "simon.parry@coshx.co.uk",
    url = "https://coshxltd@github.com/coshxltd/collab.git",
    download_url = "https://coshxltd@github.com/coshxltd/collab.git",
